////////////////////////////////////////////////////////////////////////////////
// Filename: FHashedString.h
////////////////////////////////////////////////////////////////////////////////
#ifndef _FHashedString_H_
#define _FHashedString_H_
...
public:
	...
	class Hasher
	{
		friend FHashedString;

	public:
		size_t operator()(const FHashedString & _hashedString) const
		{
	...
	public:
		bool operator() (FHashedString const& t1, FHashedString const& t2) const
		{
...
public:
	...
	template <size_t N>
	inline explicit FHashedString(const char(&str)[N]);
	explicit FHashedString(ConstCharWrapper str);
...
#define ME_HASHED_STRING_SPECIALIZATION(n)                                    \
  template <>                                                                \
  inline FHashedString::FHashedString(const char (&str)[n])                    \
